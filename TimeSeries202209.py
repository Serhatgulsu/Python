...
Guneydogu = pd.read_excel("/Users/serhatgulsu/Desktop/Time Series/Veri202209.xlsx", sheet_name="Guneydogu", header=0, index_col=0)
...
GenelHitRatioGuneydogu = np.array(Guneydogu['Ultimate Hit Ratio'])
print(GenelHitRatioGuneydogu)
for a in GenelHitRatioGuneydogu:
    GenelHitRatioGuneydogulists = [np.array(GenelHitRatioGuneydogu[i:i + 50]) for i in range(0, 79)]
    print(GenelHitRatioGuneydogulists)
GenelHitRatioGuneydogunonseasonality = [pm.auto_arima((np.array(GenelHitRatioGuneydogu[i:i + 50]).reshape(-1, 1)), seasonal=False) for i in range(0, 79)]
print(GenelHitRatioGuneydogunonseasonality)
GenelHitRatioGuneydogupredict1 = ([GenelHitRatioGuneydogunonseasonality[i].predict(1, return_conf_int=True, alpha=0.10) for i in range(0, 79)])
GenelHitRatioGuneydogupre2 = pd.DataFrame(GenelHitRatioGuneydogupredict1)
GenelHitRatioGuneydoguIntervals = pd.DataFrame({"NonSeasonality_Intervals": GenelHitRatioGuneydogupre2[1],
                          "Sira": range(1, 80)})
GenelHitRatioGuneydoguLowerInterval = [(np.concatenate(GenelHitRatioGuneydoguIntervals["NonSeasonality_Intervals"]).astype(None)).tolist()[i][0] for i in range(0, 79)]
GenelHitRatioGuneydoguUpperInterval = [(np.concatenate(GenelHitRatioGuneydoguIntervals["NonSeasonality_Intervals"]).astype(None)).tolist()[i][1] for i in range(0, 79)]
GenelHitRatioGuneydoguConfidence_Interval = pd.DataFrame({"Lower": GenelHitRatioGuneydoguLowerInterval,
                        "Upper": GenelHitRatioGuneydoguUpperInterval,
                          "Sira": range(1, 80)})
GenelHitRatioGuneydogupredict1 = ([GenelHitRatioGuneydogunonseasonality[i].predict(1) for i in range(0, 79)])
GenelHitRatioGuneydogup1 = []
for i in range(0, 79):
    GenelHitRatioGuneydogup1.append(float(str(GenelHitRatioGuneydogupredict1[i].tolist()).replace("[", "").replace("]", "")))
    print(GenelHitRatioGuneydogup1)
GenelHitRatioGuneydogulistpredict = pd.DataFrame({'Predict': GenelHitRatioGuneydogup1,
                          'Lower': GenelHitRatioGuneydoguConfidence_Interval["Lower"],
                            'Upper': GenelHitRatioGuneydoguConfidence_Interval["Upper"],
                         'Sira': range(1, 80)})
GenelHitRatioGuneydogulist = pd.DataFrame({ 'Genel %10' : 'GenelHitRatioGuneydogu’',
                       'Guneydogu aylik hit': GenelHitRatioGuneydogulists,
                      'Non-Seasonality': GenelHitRatioGuneydogunonseasonality,
                       'Hit Ratio': Guneydogu['Ultimate Hit Ratio'][49:],
                     'Sira': range(0,79),})
GenelHitRatioGuneydogufinallist = pd.merge(GenelHitRatioGuneydogulist, GenelHitRatioGuneydogulistpredict, on='Sira', how='inner')
print(GenelHitRatioGuneydogufinallist)
GenelHitRatioGuneydogufinallist["Alert"]  = [0 if (GenelHitRatioGuneydogufinallist['Hit Ratio'][i]> GenelHitRatioGuneydogufinallist["Lower"][i]) & (GenelHitRatioGuneydogufinallist['Hit Ratio'][i]< GenelHitRatioGuneydogufinallist["Upper"][i])
          else 1 for i in range(0, 78)]
print(GenelHitRatioGuneydogufinallist[GenelHitRatioGuneydogufinallist["Alert"]==1])


#Ultimate_TransferGuneydogu

GenelHitRatioTransferGuneydogu = np.array(Guneydogu["Transfer Hit Ratio"])
print(GenelHitRatioTransferGuneydogu)
for a in GenelHitRatioTransferGuneydogu:
    GenelHitRatioTransferGuneydogulists = [np.array(GenelHitRatioTransferGuneydogu[i:i + 50]) for i in range(0, 79)]
    print(GenelHitRatioTransferGuneydogulists)
GenelHitRatioTransferGuneydogunonseasonality = [pm.auto_arima((np.array(GenelHitRatioTransferGuneydogu[i:i + 50]).reshape(-1, 1)), seasonal=False) for i in range(0, 79)]
print(GenelHitRatioTransferGuneydogunonseasonality)
GenelHitRatioTransferGuneydogupredict1 = ([GenelHitRatioTransferGuneydogunonseasonality[i].predict(1, return_conf_int=True, alpha=0.10) for i in range(0, 79)])
GenelHitRatioTransferGuneydogupre2 = pd.DataFrame(GenelHitRatioTransferGuneydogupredict1)
GenelHitRatioTransferGuneydoguIntervals = pd.DataFrame({"NonSeasonality_Intervals": GenelHitRatioTransferGuneydogupre2[1],
                          "Sira": range(1, 80)})
GenelHitRatioTransferGuneydoguLowerInterval = [(np.concatenate(GenelHitRatioTransferGuneydoguIntervals["NonSeasonality_Intervals"]).astype(None)).tolist()[i][0] for i in range(0, 79)]
GenelHitRatioTransferGuneydoguUpperInterval = [(np.concatenate(GenelHitRatioTransferGuneydoguIntervals["NonSeasonality_Intervals"]).astype(None)).tolist()[i][1] for i in range(0, 79)]
GenelHitRatioTransferGuneydoguConfidence_Interval = pd.DataFrame({"Lower": GenelHitRatioTransferGuneydoguLowerInterval,
                        "Upper": GenelHitRatioTransferGuneydoguUpperInterval,
                          "Sira": range(1, 80)})
GenelHitRatioTransferGuneydogupredict1 = ([GenelHitRatioTransferGuneydogunonseasonality[i].predict(1) for i in range(0, 79)])
GenelHitRatioTransferGuneydogup1 = []
for i in range(0, 79):
    GenelHitRatioTransferGuneydogup1.append(float(str(GenelHitRatioTransferGuneydogupredict1[i].tolist()).replace("[", "").replace("]", "")))
    print(GenelHitRatioTransferGuneydogup1)
GenelHitRatioTransferGuneydogulistpredict = pd.DataFrame({'Predict': GenelHitRatioTransferGuneydogup1,
                          'Lower': GenelHitRatioTransferGuneydoguConfidence_Interval["Lower"],
                            'Upper': GenelHitRatioTransferGuneydoguConfidence_Interval["Upper"],
                         'Sira': range(1, 80)})
GenelHitRatioTransferGuneydogulist = pd.DataFrame({ 'Genel %10' : 'GenelHitRatioTransferGuneydogu’',
                       'Guneydogu aylik hit': GenelHitRatioTransferGuneydogulists,
                      'Non-Seasonality': GenelHitRatioTransferGuneydogunonseasonality,
                       'Hit Ratio': Guneydogu["Transfer Hit Ratio"][49:],
                     'Sira': range(0,79),})
GenelHitRatioTransferGuneydogufinallist = pd.merge(GenelHitRatioTransferGuneydogulist, GenelHitRatioTransferGuneydogulistpredict, on='Sira', how='inner')
print(GenelHitRatioTransferGuneydogufinallist)
GenelHitRatioTransferGuneydogufinallist["Alert"]  = [0 if (GenelHitRatioTransferGuneydogufinallist['Hit Ratio'][i]> GenelHitRatioTransferGuneydogufinallist["Lower"][i]) & (GenelHitRatioTransferGuneydogufinallist['Hit Ratio'][i]< GenelHitRatioTransferGuneydogufinallist["Upper"][i])
          else 1 for i in range(0, 78)]
print(GenelHitRatioTransferGuneydogufinallist[GenelHitRatioTransferGuneydogufinallist["Alert"]==1])

#Ultimate_YenilemeGuneydogu

GenelHitRatioYenilemeGuneydogu = np.array(Guneydogu["Yenileme Hit Ratio"])
print(GenelHitRatioYenilemeGuneydogu)
for a in GenelHitRatioYenilemeGuneydogu:
    GenelHitRatioYenilemeGuneydogulists = [np.array(GenelHitRatioYenilemeGuneydogu[i:i + 50]) for i in range(0, 79)]
    print(GenelHitRatioYenilemeGuneydogulists)
GenelHitRatioYenilemeGuneydogunonseasonality = [pm.auto_arima((np.array(GenelHitRatioYenilemeGuneydogu[i:i + 50]).reshape(-1, 1)), seasonal=False) for i in range(0, 79)]
print(GenelHitRatioYenilemeGuneydogunonseasonality)
GenelHitRatioYenilemeGuneydogupredict1 = ([GenelHitRatioYenilemeGuneydogunonseasonality[i].predict(1, return_conf_int=True, alpha=0.10) for i in range(0, 79)])
GenelHitRatioYenilemeGuneydogupre2 = pd.DataFrame(GenelHitRatioYenilemeGuneydogupredict1)
GenelHitRatioYenilemeGuneydoguIntervals = pd.DataFrame({"NonSeasonality_Intervals": GenelHitRatioYenilemeGuneydogupre2[1],
                          "Sira": range(1, 80)})
GenelHitRatioYenilemeGuneydoguLowerInterval = [(np.concatenate(GenelHitRatioYenilemeGuneydoguIntervals["NonSeasonality_Intervals"]).astype(None)).tolist()[i][0] for i in range(0, 79)]
GenelHitRatioYenilemeGuneydoguUpperInterval = [(np.concatenate(GenelHitRatioYenilemeGuneydoguIntervals["NonSeasonality_Intervals"]).astype(None)).tolist()[i][1] for i in range(0, 79)]
GenelHitRatioYenilemeGuneydoguConfidence_Interval = pd.DataFrame({"Lower": GenelHitRatioYenilemeGuneydoguLowerInterval,
                        "Upper": GenelHitRatioYenilemeGuneydoguUpperInterval,
                          "Sira": range(1, 80)})
GenelHitRatioYenilemeGuneydogupredict1 = ([GenelHitRatioYenilemeGuneydogunonseasonality[i].predict(1) for i in range(0, 79)])
GenelHitRatioYenilemeGuneydogup1 = []
for i in range(0, 79):
    GenelHitRatioYenilemeGuneydogup1.append(float(str(GenelHitRatioYenilemeGuneydogupredict1[i].tolist()).replace("[", "").replace("]", "")))
    print(GenelHitRatioYenilemeGuneydogup1)
GenelHitRatioYenilemeGuneydogulistpredict = pd.DataFrame({'Predict': GenelHitRatioYenilemeGuneydogup1,
                          'Lower': GenelHitRatioYenilemeGuneydoguConfidence_Interval["Lower"],
                            'Upper': GenelHitRatioYenilemeGuneydoguConfidence_Interval["Upper"],
                         'Sira': range(1, 80)})
GenelHitRatioYenilemeGuneydogulist = pd.DataFrame({ 'Genel %10' : 'GenelHitRatioYenilemeGuneydogu’',
                       'Guneydogu aylik hit': GenelHitRatioYenilemeGuneydogulists,
                      'Non-Seasonality': GenelHitRatioYenilemeGuneydogunonseasonality,
                       'Hit Ratio': Guneydogu["Yenileme Hit Ratio"][49:],
                     'Sira': range(0,79),})
GenelHitRatioYenilemeGuneydogufinallist = pd.merge(GenelHitRatioYenilemeGuneydogulist, GenelHitRatioYenilemeGuneydogulistpredict, on='Sira', how='inner')
print(GenelHitRatioYenilemeGuneydogufinallist)
GenelHitRatioYenilemeGuneydogufinallist["Alert"]  = [0 if (GenelHitRatioYenilemeGuneydogufinallist['Hit Ratio'][i]> GenelHitRatioYenilemeGuneydogufinallist["Lower"][i]) & (GenelHitRatioYenilemeGuneydogufinallist['Hit Ratio'][i]< GenelHitRatioYenilemeGuneydogufinallist["Upper"][i])
          else 1 for i in range(0, 78)]
print(GenelHitRatioYenilemeGuneydogufinallist[GenelHitRatioYenilemeGuneydogufinallist["Alert"]==1])
...
AllfinallistAlert = GenelHitRatioAllfinallist[GenelHitRatioAllfinallist["Alert"]==1]
TransferfinallistAlert = GenelHitRatioTransferfinallist[GenelHitRatioTransferfinallist["Alert"]==1]
YenilemefinallistAlert = GenelHitRatioYenilemefinallist[GenelHitRatioYenilemefinallist["Alert"]==1]
All60finallistAlert = GenelHitRatioAll60finallist[GenelHitRatioAll60finallist["Alert"]==1]
Transfer60finallistAlert = GenelHitRatioTransfer60finallist[GenelHitRatioTransfer60finallist["Alert"]==1]
Yenileme60finallistAlert = GenelHitRatioYenileme60finallist[GenelHitRatioYenileme60finallist["Alert"]==1]
All55finallistAlert = GenelHitRatioAll55finallist[GenelHitRatioAll55finallist["Alert"]==1]
Transfer55finallistAlert = GenelHitRatioTransfer55finallist[GenelHitRatioTransfer55finallist["Alert"]==1]
Yenileme55finallistAlert = GenelHitRatioYenileme55finallist[GenelHitRatioYenileme55finallist["Alert"]==1]
All50finallistAlert = GenelHitRatioAll50finallist[GenelHitRatioAll50finallist["Alert"]==1]
Transfer50finallistAlert = GenelHitRatioTransfer50finallist[GenelHitRatioTransfer50finallist["Alert"]==1]
Yenileme50finallistAlert = GenelHitRatioYenileme50finallist[GenelHitRatioYenileme50finallist["Alert"]==1]
All40finallistAlert = GenelHitRatioAll40finallist[GenelHitRatioAll40finallist["Alert"]==1]
Transfer40finallistAlert = GenelHitRatioTransfer40finallist[GenelHitRatioTransfer40finallist["Alert"]==1]
Yenileme40finallistAlert = GenelHitRatioYenileme40finallist[GenelHitRatioYenileme40finallist["Alert"]==1]
All30finallistAlert = GenelHitRatioAll30finallist[GenelHitRatioAll30finallist["Alert"]==1]
Transfer30finallistAlert = GenelHitRatioTransfer30finallist[GenelHitRatioTransfer30finallist["Alert"]==1]
Yenileme30finallistAlert = GenelHitRatioYenileme30finallist[GenelHitRatioYenileme30finallist["Alert"]==1]
MarmarafinallistAlert = GenelHitRatioMarmarafinallist[GenelHitRatioMarmarafinallist["Alert"]==1]
TransferMarmarafinallistAlert = GenelHitRatioTransferMarmarafinallist[GenelHitRatioTransferMarmarafinallist["Alert"]==1]
YenilemeMarmarafinallistAlert = GenelHitRatioYenilemeMarmarafinallist[GenelHitRatioYenilemeMarmarafinallist["Alert"]==1]
KaradenizfinallistAlert = GenelHitRatioKaradenizfinallist[GenelHitRatioKaradenizfinallist["Alert"]==1]
TransferKaradenizfinallistAlert = GenelHitRatioTransferKaradenizfinallist[GenelHitRatioTransferKaradenizfinallist["Alert"]==1]
YenilemeKaradenizfinallistAlert = GenelHitRatioYenilemeKaradenizfinallist[GenelHitRatioYenilemeKaradenizfinallist["Alert"]==1]
DoguAnadolufinallistAlert = GenelHitRatioDoguAnadolufinallist[GenelHitRatioDoguAnadolufinallist["Alert"]==1]
TransferDoguAnadolufinallistAlert = GenelHitRatioTransferDoguAnadolufinallist[GenelHitRatioTransferDoguAnadolufinallist["Alert"]==1]
YenilemeDoguAnadolufinallistAlert = GenelHitRatioYenilemeDoguAnadolufinallist[GenelHitRatioYenilemeDoguAnadolufinallist["Alert"]==1]
GuneydogufinallistAlert = GenelHitRatioGuneydogufinallist[GenelHitRatioGuneydogufinallist["Alert"]==1]
TransferGuneydogufinallistAlert = GenelHitRatioTransferGuneydogufinallist[GenelHitRatioTransferGuneydogufinallist["Alert"]==1]
YenilemeGuneydogufinallistAlert = GenelHitRatioYenilemeGuneydogufinallist[GenelHitRatioYenilemeGuneydogufinallist["Alert"]==1]
IcAnadolufinallistAlert = GenelHitRatioIcAnadolufinallist[GenelHitRatioIcAnadolufinallist["Alert"]==1]
TransferIcAnadolufinallistAlert = GenelHitRatioTransferIcAnadolufinallist[GenelHitRatioTransferIcAnadolufinallist["Alert"]==1]
YenilemeIcAnadolufinallistAlert = GenelHitRatioYenilemeIcAnadolufinallist[GenelHitRatioYenilemeIcAnadolufinallist["Alert"]==1]
EgefinallistAlert = GenelHitRatioEgefinallist[GenelHitRatioEgefinallist["Alert"]==1]
TransferEgefinallistAlert = GenelHitRatioTransferEgefinallist[GenelHitRatioTransferEgefinallist["Alert"]==1]
YenilemeEgefinallistAlert = GenelHitRatioYenilemeEgefinallist[GenelHitRatioYenilemeEgefinallist["Alert"]==1]
AkdenizfinallistAlert = GenelHitRatioAkdenizfinallist[GenelHitRatioAkdenizfinallist["Alert"]==1]
TransferAkdenizfinallistAlert = GenelHitRatioTransferAkdenizfinallist[GenelHitRatioTransferAkdenizfinallist["Alert"]==1]
YenilemeAkdenizfinallistAlert = GenelHitRatioYenilemeAkdenizfinallist[GenelHitRatioYenilemeAkdenizfinallist["Alert"]==1]
HR1Transfer60finallistAlert = GenelHitRatio1Transfer60finallist[GenelHitRatio1Transfer60finallist["Alert"]==1]
HR6Transfer60finallistAlert = GenelHitRatio6Transfer60finallist[GenelHitRatio6Transfer60finallist["Alert"]==1]
HR7Transfer60finallistAlert = GenelHitRatio7Transfer60finallist[GenelHitRatio7Transfer60finallist["Alert"]==1]
HR16Transfer60finallistAlert = GenelHitRatio16Transfer60finallist[GenelHitRatio16Transfer60finallist["Alert"]==1]
HR33Transfer60finallistAlert = GenelHitRatio33Transfer60finallist[GenelHitRatio33Transfer60finallist["Alert"]==1]
HR34Transfer60finallistAlert = GenelHitRatio34Transfer60finallist[GenelHitRatio34Transfer60finallist["Alert"]==1]
HR35Transfer60finallistAlert = GenelHitRatio35Transfer60finallist[GenelHitRatio35Transfer60finallist["Alert"]==1]
HR38Transfer60finallistAlert = GenelHitRatio38Transfer60finallist[GenelHitRatio38Transfer60finallist["Alert"]==1]
HR41Transfer60finallistAlert = GenelHitRatio41Transfer60finallist[GenelHitRatio41Transfer60finallist["Alert"]==1]
HR55Transfer60finallistAlert = GenelHitRatio55Transfer60finallist[GenelHitRatio55Transfer60finallist["Alert"]==1]
HR1Transfer55finallistAlert = GenelHitRatio1Transfer55finallist[GenelHitRatio1Transfer55finallist["Alert"]==1]
HR6Transfer55finallistAlert = GenelHitRatio6Transfer55finallist[GenelHitRatio6Transfer55finallist["Alert"]==1]
HR7Transfer55finallistAlert = GenelHitRatio7Transfer55finallist[GenelHitRatio7Transfer55finallist["Alert"]==1]
HR16Transfer55finallistAlert = GenelHitRatio16Transfer55finallist[GenelHitRatio16Transfer55finallist["Alert"]==1]
HR33Transfer55finallistAlert = GenelHitRatio33Transfer55finallist[GenelHitRatio33Transfer55finallist["Alert"]==1]
HR34Transfer55finallistAlert = GenelHitRatio34Transfer55finallist[GenelHitRatio34Transfer55finallist["Alert"]==1]
HR35Transfer55finallistAlert = GenelHitRatio35Transfer55finallist[GenelHitRatio35Transfer55finallist["Alert"]==1]
HR38Transfer55finallistAlert = GenelHitRatio38Transfer55finallist[GenelHitRatio38Transfer55finallist["Alert"]==1]
HR41Transfer55finallistAlert = GenelHitRatio41Transfer55finallist[GenelHitRatio41Transfer55finallist["Alert"]==1]
HR55Transfer55finallistAlert = GenelHitRatio55Transfer55finallist[GenelHitRatio55Transfer55finallist["Alert"]==1]
HR1Transfer50finallistAlert = GenelHitRatio1Transfer50finallist[GenelHitRatio1Transfer50finallist["Alert"]==1]
HR6Transfer50finallistAlert = GenelHitRatio6Transfer50finallist[GenelHitRatio6Transfer50finallist["Alert"]==1]
HR7Transfer50finallistAlert = GenelHitRatio7Transfer50finallist[GenelHitRatio7Transfer50finallist["Alert"]==1]
HR16Transfer50finallistAlert = GenelHitRatio16Transfer50finallist[GenelHitRatio16Transfer50finallist["Alert"]==1]
HR33Transfer50finallistAlert = GenelHitRatio33Transfer50finallist[GenelHitRatio33Transfer50finallist["Alert"]==1]
HR34Transfer50finallistAlert = GenelHitRatio34Transfer50finallist[GenelHitRatio34Transfer50finallist["Alert"]==1]
HR35Transfer50finallistAlert = GenelHitRatio35Transfer50finallist[GenelHitRatio35Transfer50finallist["Alert"]==1]
HR38Transfer50finallistAlert = GenelHitRatio38Transfer50finallist[GenelHitRatio38Transfer50finallist["Alert"]==1]
HR41Transfer50finallistAlert = GenelHitRatio41Transfer50finallist[GenelHitRatio41Transfer50finallist["Alert"]==1]
HR55Transfer50finallistAlert = GenelHitRatio55Transfer50finallist[GenelHitRatio55Transfer50finallist["Alert"]==1]
HR1Transfer40finallistAlert = GenelHitRatio1Transfer40finallist[GenelHitRatio1Transfer40finallist["Alert"]==1]
HR6Transfer40finallistAlert = GenelHitRatio6Transfer40finallist[GenelHitRatio6Transfer40finallist["Alert"]==1]
HR7Transfer40finallistAlert = GenelHitRatio7Transfer40finallist[GenelHitRatio7Transfer40finallist["Alert"]==1]
HR16Transfer40finallistAlert = GenelHitRatio16Transfer40finallist[GenelHitRatio16Transfer40finallist["Alert"]==1]
HR33Transfer40finallistAlert = GenelHitRatio33Transfer40finallist[GenelHitRatio33Transfer40finallist["Alert"]==1]
HR34Transfer40finallistAlert = GenelHitRatio34Transfer40finallist[GenelHitRatio34Transfer40finallist["Alert"]==1]
HR35Transfer40finallistAlert = GenelHitRatio35Transfer40finallist[GenelHitRatio35Transfer40finallist["Alert"]==1]
HR38Transfer40finallistAlert = GenelHitRatio38Transfer40finallist[GenelHitRatio38Transfer40finallist["Alert"]==1]
HR41Transfer40finallistAlert = GenelHitRatio41Transfer40finallist[GenelHitRatio41Transfer40finallist["Alert"]==1]
HR55Transfer40finallistAlert = GenelHitRatio55Transfer40finallist[GenelHitRatio55Transfer40finallist["Alert"]==1]
HR1Transfer30finallistAlert = GenelHitRatio1Transfer30finallist[GenelHitRatio1Transfer30finallist["Alert"]==1]
HR6Transfer30finallistAlert = GenelHitRatio6Transfer30finallist[GenelHitRatio6Transfer30finallist["Alert"]==1]
HR7Transfer30finallistAlert = GenelHitRatio7Transfer30finallist[GenelHitRatio7Transfer30finallist["Alert"]==1]
HR16Transfer30finallistAlert = GenelHitRatio16Transfer30finallist[GenelHitRatio16Transfer30finallist["Alert"]==1]
HR33Transfer30finallistAlert = GenelHitRatio33Transfer30finallist[GenelHitRatio33Transfer30finallist["Alert"]==1]
HR34Transfer30finallistAlert = GenelHitRatio34Transfer30finallist[GenelHitRatio34Transfer30finallist["Alert"]==1]
HR35Transfer30finallistAlert = GenelHitRatio35Transfer30finallist[GenelHitRatio35Transfer30finallist["Alert"]==1]
HR38Transfer30finallistAlert = GenelHitRatio38Transfer30finallist[GenelHitRatio38Transfer30finallist["Alert"]==1]
HR41Transfer30finallistAlert = GenelHitRatio41Transfer30finallist[GenelHitRatio41Transfer30finallist["Alert"]==1]
HR55Transfer30finallistAlert = GenelHitRatio55Transfer30finallist[GenelHitRatio55Transfer30finallist["Alert"]==1]
HR1Yenileme60finallistAlert = GenelHitRatio1Yenileme60finallist[GenelHitRatio1Yenileme60finallist["Alert"]==1]
HR6Yenileme60finallistAlert = GenelHitRatio6Yenileme60finallist[GenelHitRatio6Yenileme60finallist["Alert"]==1]
HR7Yenileme60finallistAlert = GenelHitRatio7Yenileme60finallist[GenelHitRatio7Yenileme60finallist["Alert"]==1]
HR16Yenileme60finallistAlert = GenelHitRatio16Yenileme60finallist[GenelHitRatio16Yenileme60finallist["Alert"]==1]
HR33Yenileme60finallistAlert = GenelHitRatio33Yenileme60finallist[GenelHitRatio33Yenileme60finallist["Alert"]==1]
HR34Yenileme60finallistAlert = GenelHitRatio34Yenileme60finallist[GenelHitRatio34Yenileme60finallist["Alert"]==1]
HR35Yenileme60finallistAlert = GenelHitRatio35Yenileme60finallist[GenelHitRatio35Yenileme60finallist["Alert"]==1]
HR38Yenileme60finallistAlert = GenelHitRatio38Yenileme60finallist[GenelHitRatio38Yenileme60finallist["Alert"]==1]
HR41Yenileme60finallistAlert = GenelHitRatio41Yenileme60finallist[GenelHitRatio41Yenileme60finallist["Alert"]==1]
HR55Yenileme60finallistAlert = GenelHitRatio55Yenileme60finallist[GenelHitRatio55Yenileme60finallist["Alert"]==1]
HR1Yenileme55finallistAlert = GenelHitRatio1Yenileme55finallist[GenelHitRatio1Yenileme55finallist["Alert"]==1]
HR6Yenileme55finallistAlert = GenelHitRatio6Yenileme55finallist[GenelHitRatio6Yenileme55finallist["Alert"]==1]
HR7Yenileme55finallistAlert = GenelHitRatio7Yenileme55finallist[GenelHitRatio7Yenileme55finallist["Alert"]==1]
HR16Yenileme55finallistAlert = GenelHitRatio16Yenileme55finallist[GenelHitRatio16Yenileme55finallist["Alert"]==1]
HR33Yenileme55finallistAlert = GenelHitRatio33Yenileme55finallist[GenelHitRatio33Yenileme55finallist["Alert"]==1]
HR34Yenileme55finallistAlert = GenelHitRatio34Yenileme55finallist[GenelHitRatio34Yenileme55finallist["Alert"]==1]
HR35Yenileme55finallistAlert = GenelHitRatio35Yenileme55finallist[GenelHitRatio35Yenileme55finallist["Alert"]==1]
HR38Yenileme55finallistAlert = GenelHitRatio38Yenileme55finallist[GenelHitRatio38Yenileme55finallist["Alert"]==1]
HR41Yenileme55finallistAlert = GenelHitRatio41Yenileme55finallist[GenelHitRatio41Yenileme55finallist["Alert"]==1]
HR55Yenileme55finallistAlert = GenelHitRatio55Yenileme55finallist[GenelHitRatio55Yenileme55finallist["Alert"]==1]
HR1Yenileme50finallistAlert = GenelHitRatio1Yenileme50finallist[GenelHitRatio1Yenileme50finallist["Alert"]==1]
HR6Yenileme50finallistAlert = GenelHitRatio6Yenileme50finallist[GenelHitRatio6Yenileme50finallist["Alert"]==1]
HR7Yenileme50finallistAlert = GenelHitRatio7Yenileme50finallist[GenelHitRatio7Yenileme50finallist["Alert"]==1]
HR16Yenileme50finallistAlert = GenelHitRatio16Yenileme50finallist[GenelHitRatio16Yenileme50finallist["Alert"]==1]
HR33Yenileme50finallistAlert = GenelHitRatio33Yenileme50finallist[GenelHitRatio33Yenileme50finallist["Alert"]==1]
HR34Yenileme50finallistAlert = GenelHitRatio34Yenileme50finallist[GenelHitRatio34Yenileme50finallist["Alert"]==1]
HR35Yenileme50finallistAlert = GenelHitRatio35Yenileme50finallist[GenelHitRatio35Yenileme50finallist["Alert"]==1]
HR38Yenileme50finallistAlert = GenelHitRatio38Yenileme50finallist[GenelHitRatio38Yenileme50finallist["Alert"]==1]
HR41Yenileme50finallistAlert = GenelHitRatio41Yenileme50finallist[GenelHitRatio41Yenileme50finallist["Alert"]==1]
HR55Yenileme50finallistAlert = GenelHitRatio55Yenileme50finallist[GenelHitRatio55Yenileme50finallist["Alert"]==1]
HR1Yenileme40finallistAlert = GenelHitRatio1Yenileme40finallist[GenelHitRatio1Yenileme40finallist["Alert"]==1]
HR6Yenileme40finallistAlert = GenelHitRatio6Yenileme40finallist[GenelHitRatio6Yenileme40finallist["Alert"]==1]
HR7Yenileme40finallistAlert = GenelHitRatio7Yenileme40finallist[GenelHitRatio7Yenileme40finallist["Alert"]==1]
HR16Yenileme40finallistAlert = GenelHitRatio16Yenileme40finallist[GenelHitRatio16Yenileme40finallist["Alert"]==1]
HR33Yenileme40finallistAlert = GenelHitRatio33Yenileme40finallist[GenelHitRatio33Yenileme40finallist["Alert"]==1]
HR34Yenileme40finallistAlert = GenelHitRatio34Yenileme40finallist[GenelHitRatio34Yenileme40finallist["Alert"]==1]
HR35Yenileme40finallistAlert = GenelHitRatio35Yenileme40finallist[GenelHitRatio35Yenileme40finallist["Alert"]==1]
HR38Yenileme40finallistAlert = GenelHitRatio38Yenileme40finallist[GenelHitRatio38Yenileme40finallist["Alert"]==1]
HR41Yenileme40finallistAlert = GenelHitRatio41Yenileme40finallist[GenelHitRatio41Yenileme40finallist["Alert"]==1]
HR55Yenileme40finallistAlert = GenelHitRatio55Yenileme40finallist[GenelHitRatio55Yenileme40finallist["Alert"]==1]
HR1Yenileme30finallistAlert = GenelHitRatio1Yenileme30finallist[GenelHitRatio1Yenileme30finallist["Alert"]==1]
HR6Yenileme30finallistAlert = GenelHitRatio6Yenileme30finallist[GenelHitRatio6Yenileme30finallist["Alert"]==1]
HR7Yenileme30finallistAlert = GenelHitRatio7Yenileme30finallist[GenelHitRatio7Yenileme30finallist["Alert"]==1]
HR16Yenileme30finallistAlert = enelHitRatio16Yenileme30finallist[GenelHitRatio16Yenileme30finallist["Alert"]==1]
HR33Yenileme30finallistAlert = GenelHitRatio33Yenileme30finallist[GenelHitRatio33Yenileme30finallist["Alert"]==1]
HR34Yenileme30finallistAlert = GenelHitRatio34Yenileme30finallist[GenelHitRatio34Yenileme30finallist["Alert"]==1]
HR35Yenileme30finallistAlert = GenelHitRatio35Yenileme30finallist[GenelHitRatio35Yenileme30finallist["Alert"]==1]
HR38Yenileme30finallistAlert = GenelHitRatio38Yenileme30finallist[GenelHitRatio38Yenileme30finallist["Alert"]==1]
HR41Yenileme30finallistAlert = GenelHitRatio41Yenileme30finallist[GenelHitRatio41Yenileme30finallist["Alert"]==1]
HR55Yenileme30finallistAlert = GenelHitRatio55Yenileme30finallist[GenelHitRatio55Yenileme30finallist["Alert"]==1]
...
Final = pd.concat([AllfinallistAlert, TransferfinallistAlert, YenilemefinallistAlert, All60finallistAlert, Transfer60finallistAlert,\
Yenileme60finallistAlert, All55finallistAlert, Transfer55finallistAlert, Yenileme55finallistAlert, All50finallistAlert,\
Transfer50finallistAlert, Yenileme50finallistAlert, All40finallistAlert, Transfer40finallistAlert, Yenileme40finallistAlert,\
All30finallistAlert, Transfer30finallistAlert, Yenileme30finallistAlert, MarmarafinallistAlert, TransferMarmarafinallistAlert,\
YenilemeMarmarafinallistAlert, KaradenizfinallistAlert, TransferKaradenizfinallistAlert, YenilemeKaradenizfinallistAlert,\
DoguAnadolufinallistAlert, TransferDoguAnadolufinallistAlert, YenilemeDoguAnadolufinallistAlert, GuneydogufinallistAlert, \
TransferGuneydogufinallistAlert, YenilemeGuneydogufinallistAlert, IcAnadolufinallistAlert, TransferIcAnadolufinallistAlert, \
YenilemeIcAnadolufinallistAlert, EgefinallistAlert, TransferEgefinallistAlert, YenilemeEgefinallistAlert, \
AkdenizfinallistAlert, TransferAkdenizfinallistAlert, YenilemeAkdenizfinallistAlert, HR1Transfer60finallistAlert, \
HR6Transfer60finallistAlert, HR7Transfer60finallistAlert, HR16Transfer60finallistAlert, HR33Transfer60finallistAlert, \
HR34Transfer60finallistAlert, HR35Transfer60finallistAlert, HR38Transfer60finallistAlert, HR41Transfer60finallistAlert, \
HR55Transfer60finallistAlert, HR1Transfer55finallistAlert, HR6Transfer55finallistAlert, HR7Transfer55finallistAlert, \
HR16Transfer55finallistAlert, HR33Transfer55finallistAlert, HR34Transfer55finallistAlert, HR35Transfer55finallistAlert, \
HR38Transfer55finallistAlert, HR41Transfer55finallistAlert, HR55Transfer55finallistAlert, HR1Transfer50finallistAlert, \
HR6Transfer50finallistAlert, HR7Transfer50finallistAlert, HR16Transfer50finallistAlert, HR33Transfer50finallistAlert, \
HR34Transfer50finallistAlert, HR35Transfer50finallistAlert, HR38Transfer50finallistAlert, HR41Transfer50finallistAlert, \
HR55Transfer50finallistAlert, HR1Transfer40finallistAlert, HR6Transfer40finallistAlert, HR7Transfer40finallistAlert, \
HR16Transfer40finallistAlert, HR33Transfer40finallistAlert, HR34Transfer40finallistAlert, HR35Transfer40finallistAlert, \
HR38Transfer40finallistAlert, HR41Transfer40finallistAlert, HR55Transfer40finallistAlert, HR1Transfer30finallistAlert, \
HR6Transfer30finallistAlert, HR7Transfer30finallistAlert, HR16Transfer30finallistAlert, HR33Transfer30finallistAlert, \
HR34Transfer30finallistAlert, HR35Transfer30finallistAlert, HR38Transfer30finallistAlert, HR41Transfer30finallistAlert, \
HR55Transfer30finallistAlert, HR1Yenileme60finallistAlert, HR6Yenileme60finallistAlert, HR7Yenileme60finallistAlert, \
HR16Yenileme60finallistAlert, HR33Yenileme60finallistAlert, HR34Yenileme60finallistAlert, HR35Yenileme60finallistAlert, \
HR38Yenileme60finallistAlert, HR41Yenileme60finallistAlert, HR55Yenileme60finallistAlert, HR1Yenileme55finallistAlert, \
HR6Yenileme55finallistAlert, HR7Yenileme55finallistAlert, HR16Yenileme55finallistAlert, HR33Yenileme55finallistAlert, \
HR34Yenileme55finallistAlert, HR35Yenileme55finallistAlert, HR38Yenileme55finallistAlert, HR41Yenileme55finallistAlert, \
HR55Yenileme55finallistAlert, HR1Yenileme50finallistAlert, HR6Yenileme50finallistAlert, HR7Yenileme50finallistAlert, \
HR16Yenileme50finallistAlert, HR33Yenileme50finallistAlert, HR34Yenileme50finallistAlert, HR35Yenileme50finallistAlert, \
HR38Yenileme50finallistAlert, HR41Yenileme50finallistAlert, HR55Yenileme50finallistAlert, HR1Yenileme40finallistAlert, \
HR6Yenileme40finallistAlert, HR7Yenileme40finallistAlert, HR16Yenileme40finallistAlert, HR33Yenileme40finallistAlert, \
HR34Yenileme40finallistAlert, HR35Yenileme40finallistAlert, HR38Yenileme40finallistAlert, HR41Yenileme40finallistAlert, \
HR55Yenileme40finallistAlert, HR1Yenileme30finallistAlert, HR6Yenileme30finallistAlert, HR7Yenileme30finallistAlert, \
HR16Yenileme30finallistAlert, HR33Yenileme30finallistAlert, HR34Yenileme30finallistAlert, HR35Yenileme30finallistAlert, \
HR38Yenileme30finallistAlert, HR41Yenileme30finallistAlert, HR55Yenileme30finallistAlert] ignore_index=True)



x = GenelHitRatio34Yenileme55finallist["Hit Ratio"]
y = GenelHitRatio34Yenileme55finallist["Lower"]
z = GenelHitRatio34Yenileme55finallist["Upper"]

print(x)
print(y)
print(z)

plt.plot(x, color='green', label="İstanbul - Yenileme (%55)")
