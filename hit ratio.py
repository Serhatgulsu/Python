...
print(finallist3[finallist3["Alert"]==1].shape + finallist4[finallist4["Alert"]==1].shape + finallist5[finallist5["Alert"]==1].shape)
...
finallist5.to_excel("/Users/serhatgulsu/Desktop/Time Series/finallist5.xlsx")